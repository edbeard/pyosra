...
int alternate(OBMol * pmol, const int nH[], int bondOrders []);  //This method does not work!
...
void generateDiagram(OBMol * pmol, std::ostream & ofs);  //for testing purposes only
