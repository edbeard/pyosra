...
int main()
{
    ...
    int smiles = hack_osra_process_image("a", 4, var_vec, val_vec);
...
//    py::arg("input_file") = "/home/edward/cpp/hack_osra/src/test_rgroup.jpg",
...
//    py::arg("resize") = "",
//    py::arg("preview") = ""
////    py::arg("rgroup") = std::vector<std::vector<std::string>>{{"R", "CH3"}}
//
//    );
//
//}